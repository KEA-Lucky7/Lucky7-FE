...
export default function BannerSetting() {
    ...
    const handleblogTitleChange = (e) => { // React.ChangeEvent<HTMLInputElement>를 사용하지 않아도 됩니다.
    ...
    const handleBlogIntroduceChange = (e) => { // React.ChangeEvent<HTMLInputElement>를 사용하지 않아도 됩니다.
