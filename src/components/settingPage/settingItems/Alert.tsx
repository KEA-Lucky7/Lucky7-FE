...
export default function Alert() {
  const [isPushNotificationChecked, setIsPushNotificationChecked] =
    useState(false);
  const [isMarketingNotificationChecked, setIsMarketingNotificationChecked] =
    useState(true);
  const [
    isAdvertisingNotificationChecked,
    setIsAdvertisingNotificationChecked,
  ] = useState(true);
  ...
  return (
    <S.AlertBox>
      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        ...
        >
          <img
            src={isPushNotificationChecked ? Check : NonCheck}
            alt={isPushNotificationChecked ? "체크" : "비체크"}
        ...
        <div
          style={{ display: "flex", flexDirection: "row", gap: "10px" }}
          onClick={toggleMarketingNotification}
        >
          <img
            src={isMarketingNotificationChecked ? Check : NonCheck}
            alt={isMarketingNotificationChecked ? "체크" : "비체크"}
            style={{ width: "24px", height: "24px" }}
          />
        ...
        <div
          style={{ display: "flex", flexDirection: "row", gap: "10px" }}
          onClick={toggleAdvertisingNotification}
        >
          <img
            src={isAdvertisingNotificationChecked ? Check : NonCheck}
            alt={isAdvertisingNotificationChecked ? "체크" : "비체크"}
            style={{ width: "24px", height: "24px" }}
          />
